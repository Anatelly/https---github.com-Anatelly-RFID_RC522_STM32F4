...
#if F1_CHECK
    // #error Here must be a macro for turn on AFIO clock
#endif /* F1_CHECK */
...
// ========================================================================================================
#if defined (UART6_TX_BUFFER_SIZE) || defined (UART6_RX_BUFFER_SIZE)
