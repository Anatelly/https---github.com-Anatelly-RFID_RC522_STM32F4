...
{
    return sx1276_fsk_write(&sx1276_fsk1, buffer, len);
}

ssize_t sx1276_fsk1_read (char *buffer, size_t len)
{
	return sx1276_fsk_read(&sx1276_fsk1, buffer, len);
}
...
{
	return sx1276_fsk_write(&sx1276_fsk2, buffer, len);
}

ssize_t sx1276_fsk2_read (char *buffer, size_t len)
{
	return sx1276_fsk_read(&sx1276_fsk2, buffer, len);
}
...
{
	return sx1276_fsk_write(&sx1276_fsk3, buffer, len);
}

ssize_t sx1276_fsk3_read (char *buffer, size_t len)
{
	return sx1276_fsk_read(&sx1276_fsk3, buffer, len);
}
